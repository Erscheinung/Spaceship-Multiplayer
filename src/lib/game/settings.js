...
export const DIFFICULTIES = {
  easy: { label: 'Scenic', spawn: 1.3, speed: .8, damage: 1, aim: true, repairSeconds: 14 },
  normal: { label: 'Survival', spawn: .72, speed: 1.2, damage: 1, aim: true, repairSeconds: 24 },
  brutal: { label: 'Brutal', spawn: .38, speed: 1.7, damage: 2, aim: false, repairSeconds: 0 }
};
